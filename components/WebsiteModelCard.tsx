...
const WebsiteModelCard = ({
  ...
  return (
    <div
      className={`w-screen flex py-48 justify-center items-center max-tablet:py-28 max-tablet:h-auto ${
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <span className="text-white opacity-10 text-[200px] font-extrabold absolute -bottom-12 left-0 leading-none max-mobile:text-[100px] translate-x-[-60%] max-mobile:translate-x-[-10%]">
            {projectNum}
          </span>
        </div>
        <div
...
export default WebsiteModelCard;

...
const ServiceCard = ({ icon, title, serviceUrl, btnText, index }: Props) => {
  return (
    <Link
      href={serviceUrl}
      className="group/service w-[30%] max-tablet:w-full min-h-[140px] flex flex-col justify-center items-center bg-[#F1FCFF] hover:bg-[#4892D6] pl-9 rounded-2xl relative"
      data-aos="fade-down"
      data-aos-offset="200"
